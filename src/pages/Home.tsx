      ...
      <div className="w-full max-w-2xl px-6 py-12 flex flex-col items-center">
        ...
        <div className="w-full flex flex-col md:flex-row gap-6 items-center justify-center">
          <button
            ...
            className="w-full md:w-64 px-8 py-6 bg-white text-blue-600 text-xl font-semibold rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 hover:bg-blue-50"
          >
            Login
          </button>
